...
const EditGeneralInfoForm=()=> {
    ...
    return (
        <div style={{ marginLeft: '5%', marginRight: '5%'}}>
            ...
            <div>
            <Button variant="contained" style={{marginRight: '20px'}} type="submit" color='secondary' onClick={()=> navigate('/user/Profile')}>Go Back</Button>
            <Button variant="contained" type="submit" onClick={handleSubmit}>Save Profile</Button>
            </div>
        </form>
            </Card>
        </div>
